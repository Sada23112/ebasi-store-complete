      ...
      <div className="container mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <h1 className="text-xl sm:text-2xl font-serif font-bold text-foreground hover:text-primary transition-colors cursor-pointer tracking-tight">
                EBASI STORE
              </h1>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div ref={searchContainerRef} className="relative hidden sm:flex items-center">
              ...
              {isSearchExpanded && (
                <Button variant="ghost" size="icon" onClick={handleSearchCollapse} className="ml-2 text-foreground transition-colors active:scale-95 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0">
                  <X className="h-4 w-4" />
                ...
                <div className="flex flex-col space-y-4 mt-8">
                  {menuItems.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="text-foreground hover:text-primary transition-colors duration-200 px-3 py-2.5 text-lg font-medium min-h-[44px] flex items-center"
                  ...
                  <Link
                    href="/wishlist"
                    className="text-foreground hover:text-primary transition-colors duration-200 px-3 py-2.5 text-lg font-medium flex items-center justify-between min-h-[44px]"
                    onClick={() => setIsOpen(false)}
                  >
